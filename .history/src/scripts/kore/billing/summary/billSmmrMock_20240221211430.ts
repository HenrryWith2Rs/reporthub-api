export function billSmmrDummyData() {
  return [
    ...
    },
    {
      ...
      Query:
        "SELECT count(DISTINCT ucid) FROM ( SELECT ucid,trans,CALLSTOP, ROW_NUMBER() OVER (PARTITION BY ucid ORDER BY CASE WHEN trans = 'Y' THEN 0 ELSE 1 end) AS row_trans FROM IVR_CALLFLOW.IVRCALLINFO i WHERE i.CALLSTOP BETWEEN TO_DATE('dateStart 00:00:00', 'YYYY-MM-DD hh24:mi:ss') AND TO_DATE('dateEnd 23:59:59', 'YYYY-MM-DD hh24:mi:ss') AND i.APPSERVER LIKE '%mod%' AND i.poc LIKE '%Billing%' AND i.poc NOT LIKE '%Mobile%' AND i.poc NOT LIKE '%Ent%' AND ucid NOT IN (SELECT ucid FROM kore.CALLINFO c WHERE CALLSTOP BETWEEN TO_DATE('dateStart 00:00:00', 'YYYY-MM-DD hh24:mi:ss') AND TO_DATE('dateEnd 23:59:59', 'YYYY-MM-DD hh24:mi:ss')) ) WHERE row_trans = '1' AND trans = 'N'",
      Result: '0',
      Cell_Result: 'E4',
      Percentage: '0',
      Cell_Percentage: 'F4',
    ...
    },
    {
      ...
      Query:
        "SELECT count(DISTINCT ucid) FROM ( SELECT ucid,trans,CALLSTOP, ROW_NUMBER() OVER (PARTITION BY ucid ORDER BY CASE WHEN trans = 'Y' THEN 0 ELSE 1 end) AS row_trans FROM IVR_CALLFLOW.IVRCALLINFO i WHERE i.CALLSTOP BETWEEN TO_DATE('dateStart 00:00:00', 'YYYY-MM-DD hh24:mi:ss') AND TO_DATE('dateEnd 23:59:59', 'YYYY-MM-DD hh24:mi:ss') AND i.APPSERVER LIKE '%mod%' AND i.poc LIKE '%Billing%' AND i.poc NOT LIKE '%Mobile%' AND i.poc NOT LIKE '%Ent%' AND ucid NOT IN (SELECT ucid FROM kore.CALLINFO c WHERE CALLSTOP BETWEEN TO_DATE('dateStart 00:00:00', 'YYYY-MM-DD hh24:mi:ss') AND TO_DATE('dateEnd 23:59:59', 'YYYY-MM-DD hh24:mi:ss')) ) WHERE row_trans = '1' AND trans = 'Y'",
      Result: '0',
      Cell_Result: 'G4',
      Percentage: '0',
      Cell_Percentage: 'H4',
    ...
    },
    {
      ...
      Query:
        "SELECT count(DISTINCT ucid) FROM IVR_CALLFLOW.IVRCALLINFO i WHERE i.CALLSTOP BETWEEN TO_DATE('dateStart 00:00:00', 'YYYY-MM-DD hh24:mi:ss') AND TO_DATE('dateEnd 23:59:59', 'YYYY-MM-DD hh24:mi:ss') AND i.APPSERVER LIKE '%mod%' AND i.poc LIKE '%Billing%' AND i.poc NOT LIKE '%Mobile%' AND i.poc NOT LIKE '%Ent%' AND ucid NOT IN (SELECT ucid FROM kore.CALLINFO c WHERE CALLSTOP BETWEEN TO_DATE('dateStart 00:00:00', 'YYYY-MM-DD hh24:mi:ss') AND TO_DATE('dateEnd 23:59:59', 'YYYY-MM-DD hh24:mi:ss')) AND poc = 'Billing_Increase'",
      Result: '0',
      Cell_Result: 'D5',
      Percentage: '100',
      Cell_Percentage: '',
